...
## How to install
I recommend installing it on a fresh install of Arch Linux, but you can use it on an existing install too. Here's the commands to install it:
```
git clone https://bunnybunnybun/TacOS
cd TacOS
./install_script.sh
```
## Credits:
