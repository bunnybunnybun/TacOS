...
from pages.Network_Settings import NetworkSettingsPage
...
class MainWindow(Gtk.Window):
    def __init__(self):
        ...
        self.stack.add_titled(self.network_settings_page, "Network_Settings", "Network Settings")
    ...
    def switch_theme(self, widget):
        ...
        if self.current_theme == self.css_provider1:
