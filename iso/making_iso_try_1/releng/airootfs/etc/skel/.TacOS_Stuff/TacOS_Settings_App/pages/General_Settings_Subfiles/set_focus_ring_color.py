...
def set_focus_ring_color_daisies(widget, color_value="#0f4c5c"):
    ...
    update_focus_ring_color_in_kdl(str(Path.home() / ".TacOS_Stuff/TacOS_Settings_App/pages/General_Settings_Subfiles/niri_config_file_sections/layout/daisies_layout_part_2.kdl"), width_value)
...
def set_focus_ring_color_minimal(widget, color_value="#0f4c5c"):
    width_value = color_value if color_value is not None else "#0f4c5c"
    update_focus_ring_color_in_kdl(str(Path.home() / ".TacOS_Stuff/TacOS_Settings_App/pages/General_Settings_Subfiles/niri_config_file_sections/layout/minimal_layout_part_2.kdl"), width_value)
...
def set_focus_ring_color_magic(widget, color_value="#0f4c5c"):
    width_value = color_value if color_value is not None else "#0f4c5c"
    update_focus_ring_color_in_kdl(str(Path.home() / ".TacOS_Stuff/TacOS_Settings_App/pages/General_Settings_Subfiles/niri_config_file_sections/layout/magic_layout_part_2.kdl"), width_value)
...
def set_focus_ring_color_fall(widget, color_value="#0f4c5c"):
    width_value = color_value if color_value is not None else "#0f4c5c"
    update_focus_ring_color_in_kdl(str(Path.home() / ".TacOS_Stuff/TacOS_Settings_App/pages/General_Settings_Subfiles/niri_config_file_sections/layout/fall_layout_part_2.kdl"), width_value)
