...
class GeneralSettingsPage(Gtk.Box):
    def __init__(self):
        ...
        theme_button_1.get_style_context().add_class("theme_buttons")
        theme_button_2 = Gtk.Button(label="Minimal")
        theme_button_2.connect("clicked", self.Set_Theme_Minimal)
        theme_button_2.get_style_context().add_class("theme_buttons")
        theme_button_3 = Gtk.Button(label="Magic")
        theme_button_3.connect("clicked", self.Set_Theme_Magic)
        theme_button_3.get_style_context().add_class("theme_buttons")
        theme_button_4 = Gtk.Button(label="Fall/Autumn")
        theme_button_4.get_style_context().add_class("theme_buttons")
        self.add(label_1)
        self.add(theme_grid)
