...
def okdoitnowdaisies(widget, scale_value=5):
...
def okdoitnowminimal(widget, scale_value=5):
    width_value = scale_value if scale_value is not None else 5
...
def okdoitnowmagic(widget, scale_value=5):
    width_value = scale_value if scale_value is not None else 5
...
def okdoitnowfall(widget, scale_value=5):
    width_value = scale_value if scale_value is not None else 5
